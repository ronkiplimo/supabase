...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={6}>
    ...
    <StepHikeCompact.Code>
      ...
      const supabasePublishableKey = import.meta.env.PUBLIC_SUPABASE_PUBLISHABLE_KE
  ...
  <StepHikeCompact.Step step={8}>
    ...
    - Change your [Site URL](/dashboard/project/_/auth/url-configuration) to `https://localhost:4321`
