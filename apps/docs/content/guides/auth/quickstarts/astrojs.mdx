...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Code>
      ...
      SUPABASE_PUBLISHABLE_KEY=sb_publishable_... or anon key
      ```
  ...
  <StepHikeCompact.Step step={8}>
    ...
    Create a new file at `src/pages/auth/callback.astro` to handle the email confirmation callback. The Supabase SSR library automatically processes the confirmation token:
    ...
    <StepHikeCompact.Code>
      ...
      <html>
        ...
        <body>
          ...
          <p>If you are not redirected, <a href="/auth/signin">sign in here</a></p>
        </body>
      </html>
      ```
