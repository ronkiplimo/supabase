...
subtitle: 'Learn how to create a Supabase project, add some sample data, and query from an Astro app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={7}>
    ...
    This queries all the rows from the `instruments` table in Supabase and renders them on the page.
  ...
  <StepHikeCompact.Step step={8}>
    ...
    Run the development server, go to http://localhost:4321/instruments in a browser and you should see the list of instruments.
