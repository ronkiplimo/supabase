...
<Admonition type="tip" label="Recommended workflow">

Start with auto-join **disabled** to test your SSO configuration. Once SSO login is working correctly, enable auto-join if desired.
