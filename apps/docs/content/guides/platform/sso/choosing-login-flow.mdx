...
Start with IdP-initiated, the default behavior. It requires no domain configuration, and works for most of enterprise use cases. You can enable SP-initiated later if needed.
