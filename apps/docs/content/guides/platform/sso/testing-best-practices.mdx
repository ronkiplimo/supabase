...
#### "I enabled auto-join but users aren't automatically joining"
...
#### "I can't invite users with the right authentication type"
...
#### "I deleted my SSO provider and now members can't log in"
...
#### Maintain at least one non-SSO owner account (CRITICAL)
...
- Document SSO configuration in your organization's runbooks
