---
title: 'Stripe Sync Engine: from supabase to stripe'
description: 'The Stripe Sync Engine, originally built by Supabase, is now part of the Stripe GitHub org'
author: raminder_singh, matt_linkous, gregor_vand, ana_mogul
imgSocial: stripe-sync-engine-donation/og.png
imgThumb: stripe-sync-engine-donation/thumb.png
categories:
  - company
tags:
  - stripe
...
Stripe engineers contributed directly to the repo: incremental sync using cursor-based pagination, JSONB storage with generated columns, multi-account support for [Stripe Connect](https://stripe.com/en-ca/connect) platforms, and a new CLI with proper event ordering.
